        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              ...
              <div class="col-sm-2">
                <Link className="btn btn-primary" to="/addcity">
                  + Add city
                </Link>
              </div>
            </div>
                        ...
                        {city?.data?.map((val, index) => {
                          return (
                            <tr>
                              ...
                              <td>
                                <Link
                                  to={`/edit-city/${val._id}`}
                                  state={{ datas: val, id: val._id ,stateid:val.stateid}}
                                >
